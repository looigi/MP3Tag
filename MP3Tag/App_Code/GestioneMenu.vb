...
Public Class GestioneMenu : Inherits MenuItem
    ...
    Public Sub New(ByVal FontName As String, ByVal FontSize As Integer, ByVal text As String, ByVal icon As Image, ByVal iconSize As Integer, ByVal onClickP As EventHandler, ByVal shortcut As Shortcut)
        ' MyBase.New(text, onClickP, shortcut)
        ...
        m_Icon = RidimensionaImmagine(icon, iconSize)
    ...
    Public Sub ImpostaImmagineDaImage(Image As Bitmap, iconsize As Integer)
        Dim bmp As Image = RidimensionaImmagine(Image, iconsize)
        m_Icon = bmp
    End Sub
