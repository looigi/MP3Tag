...
Public Class Download
	...
	Public Sub CreaEPulisceCartellaDiLavoro()
		...
		For i As Integer = 1 To qFiles
			If Filetti(i).ToUpper.Contains(".XML") Then
	...
	Public Function ScaricaPagina(Url As String) As Boolean
		...
		Else
			Try
				...
				ScaricaFileAsincrono(Url, sNomeFileConPercorso)
			Catch ex As Exception
				'MsgBox(ex.Message)
				Ok = False
			End Try
    ...
    Public Sub ScaricaFileAsincrono(Url As String, sNomeFile As String)
        StaScaricando = True
        Blocca = False
        Inizio = Now
